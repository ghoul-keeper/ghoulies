...
export default function Home() {
  let anchorId =
    typeof window !== "undefined"
      ...
      : "";
  let spawnAGhoulie = useRef(null);
  let spawnAGhoulieId = "spawn-a-ghoulie";

  let roadmap = useRef(null);
  let roadmapId = "roadmap";

  let kensaKorbi = useRef(null);
  let kensaKorbiId = "kensa-korbi";

  let captainsLog = useRef(null);
  let captainsLogId = "captains-log";

  let objOfScrolls = {
    spawnAGhoulie: () => {
      spawnAGhoulie.current.scrollIntoView();
    },
    roadmap: () => {
      roadmap.current.scrollIntoView();
    },
    kensaKorbi: () => {
      kensaKorbi.current.scrollIntoView();
    },
    captainsLog: () => {
      captainsLog.current.scrollIntoView();
    },
  };

  useEffect(() => {
    setTimeout(() => {
      if (anchorId === spawnAGhoulieId) {
        spawnAGhoulie.current.scrollIntoView({ behavior: "smooth" });
      } else if (anchorId === roadmapId) {
      ...
      } else if (anchorId === captainsLogId) {
        captainsLog.current.scrollIntoView({ behavior: "smooth" });
      }
    }, 1000);
  }, []);
  ...
  return (
    <div>
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="book-ghoulie text-white mt-16 md:mt-24 py-10 relative">
          <div className="inside px-8 md:px-0">
            <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="kensa-korbi text-white mt-16 md:mt-24 py-10 relative">
          <div className="inside px-8 md:px-0">
            <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="roadmap text-white mt-16 md:mt-24 py-4 pb-14 md:pb-4">
